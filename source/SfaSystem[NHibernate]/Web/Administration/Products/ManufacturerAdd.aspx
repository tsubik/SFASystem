<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/MasterPage.master" AutoEventWireup="true" CodeFile="ManufacturerAdd.aspx.cs" Inherits="Administration_Products_ManufacturerAdd" %>
...
<div class="section-header">
    <div class="title">
        ...
        Dodawanie producenta<a href="<%=ResolveUrl("~/Administration/Products/Manufacturers.aspx") %>" title="Powrót do listy producentów">(Powrót do listy producentów)</a>
    </div>
    <div class="options">

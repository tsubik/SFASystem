<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/MasterPage.master"
    AutoEventWireup="true" CodeFile="SalesByProductGroup.aspx.cs" Inherits="Administration_Reports_SalesByProductGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            Raport sprzedaży - grupy produktów
        </div>
        <div class="options">
    ...
    <rsweb:ReportViewer ID="rvSales" runat="server" Font-Names="Verdana" Font-Size="8pt"
        ...
        <ServerReport ReportPath="/SFASystemReports/SalesByCategories" />
    </rsweb:ReportViewer>
</asp:Content>

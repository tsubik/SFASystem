<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/MasterPage.master" AutoEventWireup="true" CodeFile="SalesByTerritory.aspx.cs" Inherits="Administration_Reports_SalesByTerritory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="Server">
    ...
    <rsweb:ReportViewer ID="rvSales" runat="server" Font-Names="Verdana" Font-Size="8pt"
        ...
        ShowParameterPrompts="False" ShowZoomControl="False" Width="100%" ShowToolBar="False" 
        >
        <ServerReport ReportPath="/SFASystemReports/SalesByTerritory" />
    </rsweb:ReportViewer>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/MasterPage.master" AutoEventWireup="true" CodeFile="BestCustomers.aspx.cs" Inherits="Administration_Reports_BestCustomers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph1" runat="Server">
    <div class="section-header">
        <div class="title">
            ...
            Raport sprzedaży - Top 10 klientów w wybranym czasie
        </div>
        <div class="options">
    ...
    <rsweb:ReportViewer ID="rvSales" runat="server" Font-Names="Verdana" Font-Size="8pt"
        ...
        >
        <ServerReport ReportPath="/SFASystemReports/BestCustomers" />
    </rsweb:ReportViewer>
</asp:Content>
